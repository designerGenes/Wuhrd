...
public class ANLongTapButton: UIButton
{
  ...
  @IBInspectable public var radiusBonus: CGFloat = 0
    ...
    func start(sender: AnyObject, forEvent event: UIEvent)
    {
        ...
        circleLayer!.path = UIBezierPath(arcCenter: center, radius: radius+self.radiusBonus, startAngle: degreesToRadians(startAngle), endAngle: degreesToRadians(startAngle + 360), clockwise: true).CGPath
